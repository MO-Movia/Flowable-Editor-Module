    ...
    ACTIONS: {
        ...
        saveModel: function (services) {
            ...
            _internalCreateModal({
                backdrop: true,
                keyboard: true,
                template: './assets/process/editor-app/popups/save-model.html?version=' + Date.now(),
        ...
        validate: function(services) {
        	...
        	_internalCreateModal({
                backdrop: true,
                keyboard: true,
                template: './assets/process/editor-app/popups/validate-model.html?version=' + Date.now(),
                scope: services.$scope
            }, services.$modal, services.$scope);
		},
